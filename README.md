...
> **v3.x 为 Beta 版本** — 强化学习引擎和观察学习仍在迭代中，可能存在不稳定行为。
...
基于 Canvas 像素分析的视觉系统，使用 **zorr.pro 稀有度颜色体系**：

| 稀有度 | 颜色 | 识别内容 |
|---|---|---|
| Common | `#33FF33` 绿 | 普通怪物/花瓣 |
| Unusual | `#FFFF33` 黄 | 罕见怪物/花瓣 |
| Rare | `#3333FF` 蓝 | 稀有怪物/花瓣 |
| Epic | `#9900CC` 紫 | 史诗怪物/花瓣 |
| Legendary | `#FF0033` 红 | 传奇怪物/花瓣 |
| Mythic | `#33FFFF` 青 | 神话怪物/花瓣 |
| Ultra | `#FF0099` 粉 | 究极怪物/花瓣 |
| Super | `#33FF99` 薄荷 | 超级怪物/花瓣 |
| Omega | `#FF00FF` 紫红 | 终末怪物/花瓣 |

背景过滤：草地绿色、石径灰色、泥地棕色、深绿灌木/墙壁
